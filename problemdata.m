...
numberofjobs=[10 20 30 40];

numberofsublot= [2 6 10];

numberofstages=[2 3 4];
...
for zz=1:4
    if zz==1
        numberofjobs=10;
        maxizinverilengecikme=10000;
    elseif zz==2
        numberofjobs=20;
        maxizinverilengecikme=30000;
    elseif zz==3
        numberofjobs=30;
        maxizinverilengecikme=60000;
    elseif zz==4
        numberofjobs=40;
        maxizinverilengecikme=90000;
    end
    for z=1:27
        if z==1
            numberofsublot=4;
        ...
        for i=1:numberofjobs
            for j=1:numberofstages*asamamakinesayisi
                if (rand>0.5)
                    mam(i,j)=1;
                else
                    mam(i,j)=0;
        ...
        tnumberofsublot=numberofsublot*size(mam,1);%numberofublot her lot un kaç alt parçaya bölüneceği tnumberofsublot ise toplam sublot sayısı

        mam2=mam;
        pt2=pt;
        ls2=ls/numberofsublot; %sublot sizeların eş olduğu durum
        for i=2:numberofsublot
            mam2=[mam2; mam];
            pt2=[pt2; pt];
            ls2=[ls2; ls/numberofsublot];
        end
        population_size=numberofjobs*5;
        ...
        crprob=1;
        % yukarıda   maxizinverilengecikme=1000;
        numberofelitistindividuals=2;
        iteration_number=200+numberofjobs*10;
